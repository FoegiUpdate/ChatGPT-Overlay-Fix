...
- **3.0.0** - current version: one-shot fix, automatic watcher, tray controls, status tracking and autostart manager. Available as the [`v3.0.0` release](https://github.com/FoegiUpdate/ChatGPT-Overlay-Fix/releases/tag/v3.0.0).
